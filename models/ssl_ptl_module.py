...
class SSL_PTLModule(pl.LightningModule):
    ...
    def training_step(self, batch , step):
        ...
        self.log("Train_Reconstruction_loss", reconstruction_loss_value ,  batch_size=batch_size)
    ...
    def validation_step(self, batch , batch_idx):
        ...
        self.log("Validation_Reconstruction_loss", reconstruction_loss_value ,  batch_size=batch_size)
