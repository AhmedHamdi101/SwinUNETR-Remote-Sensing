...
from main_utils.dataset_utils import rasterio_read_img , normalize_tensor , drop_channel , volume_inpainting
...
class SentinelDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        main_img_volume = volume_inpainting(main_img)
        main_img_volume_channel , channel_GT , volume_GT = drop_channel(main_img_volume)        
        ...
        sample = {  "X": main_img_volume_channel,
                    ...
                    "Y":main_img , "Y_PATH":sample["X"] , "Y_CHANNEL": channel_GT , "Y_INVOLUME":volume_GT
                    }
